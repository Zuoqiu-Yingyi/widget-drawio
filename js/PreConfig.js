...
window.DRAWIO_BASE_URL = `${window.location.origin}${window.location.pathname}`;
// window.DRAWIO_VIEWER_URL = null; // Replace your path to the viewer js, e.g. https://www.example.com/js/viewer.min.js
window.DRAWIO_VIEWER_URL = `${window.location.origin}${window.location.pathname}js/viewer.min.js`;
